...
<body class="d-flex flex-column h-100">
    ...
    <header id="header">
        <?php
        NavBar::begin([
            'brandLabel' => Yii::t('app', '后台管理系统'),
            'brandUrl' => '/core/admin/index',
        ...
        $role = 'admin';
        $header_content = '';
        do_action("header_content", $header_content);
        echo "<span style='margin-left:10px;'>" . $header_content . "</span>";
        // 右侧用户菜单
        echo Nav::widget([
        ...
        <div class="row">
            ...
            <main class="main-content">
                <?php if (!empty($this->params['breadcrumbs'])): ?>
                    <?= Breadcrumbs::widget([
                        'homeLink' => ['label' => Yii::t('app', '首页'), 'url' => '/core/admin'],
