                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <?= $form->field($model, 'new_phone_code')->textInput([
                                'placeholder' => Yii::t('app', '请输入短信验证码'),
                                'class' => 'form-control'
                            ])->label(Yii::t('app', '短信验证码')) ?>
                            <div class="text-end mt-2">
                                <button type="button" class="btn btn-sm btn-outline-primary" id="send-phone-code">
                                    <?= Yii::t('app', '获取验证码') ?>
                                </button>
                            </div>
                        </div>
...
$('#send-phone-code').click(function() {
    ...
    $.post('/core/user-setting/send-phone-code', {phone: newPhone}, function(response) {
        if (response.code == 0) {
