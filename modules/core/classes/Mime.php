...
class Mime
{
     ...
     * @param $url URL
     */
    public static function getUrlMime($url)
    {
        if (strpos($url, '://') !== false) {
            $contextOptions = [
                'ssl' => [
     ...
     * @param $just_return_ext 是否只返回扩展名
     */
    public static function getContentMime($content, $just_return_ext = false)
    {
